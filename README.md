...
| Desktop — Hero | Equipment Catalogue | Equipment Detail |
|:-:|:-:|:-:|
| ![AgriHire hero: green gradient landing with "Agricultural Equipment Hire Made Simple" headline and Browse Equipment / Find a Store CTAs](docs/showcase/hero.webp) | ![Equipment for Hire: category filter chips (Chainsaws, Excavators, Tractors…) with product cards showing daily hire rates](docs/showcase/equipment.webp) | ![Compact Tractor 25HP detail: pricing tiers — Standard $100/day, Extended $85/day, Long-term $70/day — with multi-store availability](docs/showcase/equipment-item.webp) |

| Promotions | Mobile |
|:-:|:-:|
| ![Promotions page: current deals — Winter Warmup 10% OFF, Spring Sale 2025 25% OFF, New Customer 15% OFF with promo codes](docs/showcase/promotions.webp) | ![AgriHire on mobile: responsive hero with full-width Browse Equipment CTA and Equipment Categories section below](docs/showcase/mobile-hero.webp) |

### Demo

![AgriHire demo: landing page scrolls through hero and equipment categories, then navigates to Equipment for Hire browse with category filter chips and daily pricing](docs/showcase/demo.gif)
<!-- SHOWCASE:END -->
